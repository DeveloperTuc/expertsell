...
return [
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto permite una forma
    | rápida de especificar un mensaje de idioma personalizado específico para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para intercambiar los nombres de atributos por algo más amigable para el lector.
    |
    */
