...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{url('/admin/compras/create')}}" id="form_compra" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-2">
                    ...
                    <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($tmp_compras as $tmp_compra)
                                    <tr>
                                        ...
                                        <td style="text-align: center">$
                                            {{ $costo = $tmp_compra->producto->precio_compra * $tmp_compra->cantidad }}
                                        </td>
                                        <td style="text-align: center">
                                            <button type="button" class="btn btn-danger delete-btn"
                                                data-id="{{ $tmp_compra->id }}"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    @php
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6">
                                    <input id="nombre_proveedor" type="text" class="form-control font-weight-bold"
