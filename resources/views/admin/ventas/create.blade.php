...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{url('/admin/ventas/create')}}" id="form_venta" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-2">
                                                                ...
                                                                <td style="text-align: center">
                                                                    @if(!empty($producto->imagen))
                                                                        <img src="{{ asset('storage/' . $producto->imagen) }}"
                                                                            ...
                                                                            alt="imagen de producto">
                                                                    @else
                                                                        <img src="https://ui-avatars.com" width="50px"
                                                                            height="50px" alt="sin imagen">
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                            ...
                                                            <td style="text-align: center;">
                                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-identificacion_tributaria="{{ $cliente->identificacion_tributaria }}">
                                                                        Seleccionar
                                                                    </button>
                                                                </div>
                                                            </td>
...
$total_venta = 0;?>
                        @foreach ($tmp_ventas as $tmp_venta)
                            <tr>
                                ...
                                <td style="text-align: center">$
                                    {{ $costo = $tmp_venta->producto->precio_venta * $tmp_venta->cantidad }}
                                </td>
                                <td style="text-align: center">
                                    <button type="button" class="btn btn-danger delete-btn"
                                        data-id="{{ $tmp_venta->id }}"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                            @php
                ...
                <div class="col-md-6">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            <input id="fecha" type="date" class="form-control" name="fecha"
                                value="{{ old('fecha', date('Y-m-d')) }}" autocomplete="off">
                            @error('fecha')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6 ml-0">
                            <input id="nombre_cliente_select" type="text" class="form-control" value="S/N" readonly>
                            @error('nombre_cliente')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                    ...
                    <div class="row mb-2">
                        <label class="col-form-label col-md-4" for="identificacion_tributaria"
                            style="text-align:right">CUIL/CUIT</label>
                        <div class="col-md-6">
                            <input type="text" id="identificacion_tributaria_select" class="form-control" value="S/C"
                                readonly>
                            @error('identificacion_tributaria')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
...
<script>
    ...
    $('.btn-seleccionar-cliente').click(function () {
        ...
        var identificacion_tributaria = $(this).data('identificacion_tributaria')
