...
<div class="row">
    <div class="col-md-9">
        <div class="card card-outline card-primary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{url('/admin/proveedores/create')}}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="celular" value="{{ old('celular') }}" autocomplete="off" required>
                                @error('celualr')
                                    <small style="...">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="empresa" class="form-control" name="empresa" value="{{ old('empresa') }}" required>
                                @error('empresa')
                                    <small style="...">{{$message}}</small>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="direccion" value="{{ old('direccion') }}" autocomplete="off" required>
                                @error('direccion')
                                    <small style="...">{{$message}}</small>
                                @enderror
                            </div>
