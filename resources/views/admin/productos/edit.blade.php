...
<h1><b>Modificar datos del producto</b></h1>
<hr>
@stop
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <center><output id="list">
                                    <img src="{{asset('storage/' . $producto->imagen)}}" class="img-fluid" alt="logo">
                                </output></center>
                                <script>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="codigo" value="{{ $producto->codigo }}" autocomplete="off" required>
                                            @error('codigo')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="precio_compra" value="{{ $producto->precio_compra }}"
                                            required>
                                            @error('precio_compra')
                                                <small style="...">{{$message}}</small>
                                            @enderror
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="stock_maximo" value="{{ $producto->stock_maximo }}"
                                            required>
                                            @error('stock_maximo')
                                                <small style="...">{{$message}}</small>
                                            @enderror
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="descripcion"
                                            value="{{ $producto->descripcion }}" autocomplete="off" required>
                                            @error('descripcion')
                                                <small style="...">{{$message}}</small>
                                            @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="fecha_ingreso"
                                            value="{{ $producto->fecha_ingreso }}" autocomplete="off" required>
                                            @error('fecha_ingreso')
                                                <small style="...">{{$message}}</small>
                                            @enderror
                                    </div>
