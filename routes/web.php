...
Route::get('/crear-empresa/pais/{id_pais}', [App\Http\Controllers\EmpresaController::class, 'buscar_provincia'])->name('admin.empresas.create.buscar_provincia');

Route::get('/crear-empresa/provincia/{id_provincia}', [App\Http\Controllers\EmpresaController::class, 'buscar_ciudad'])->name('admin.empresas.create.buscar_ciudad');
...
Route::get('/admin/configuracion/pais/{id_pais}', [App\Http\Controllers\EmpresaController::class, 'buscar_por_pais'])->name('admin.empresas.buscar_por_pais');

Route::get('/admin/configuracion/provincia/{id_provincia}', [App\Http\Controllers\EmpresaController::class, 'buscar_por_provincia'])->name('admin.empresas.buscar_por_provincia');
...
Route::post('/admin/ventas/detalle', [App\Http\Controllers\DetalleVentaController::class, 'store'])->name('admin.ventas.detalle.store')->middleware('auth');
